...
public class LaboratorioController {
	...
	public ResponseEntity<WrapperResponse<List<LaboratorioDTO>>> findAll() {
		...
		return new WrapperResponse<>(true, "listado de laboratorios encontrado de manera exitosa", arragloLaboratoriosDto)
	...
	public ResponseEntity<WrapperResponse<LaboratorioDTO>> findById(@PathVariable("id") Long id) {
		...
		return new WrapperResponse<>(true, "laboratorio encontrado de manera exitosa", laboratorioDto).createResponse(HttpStatus.OK);
	}
	...
	public ResponseEntity<WrapperResponse<LaboratorioDTO>> create(@RequestBody LaboratorioDTO laboratorio) {
		...
		return new WrapperResponse<>(true, "laboratorio creado de manera exitosa", laboratorioDto).createResponse(HttpStatus.CREATED);
	}
	...
	public ResponseEntity<WrapperResponse<LaboratorioDTO>> update(@RequestBody LaboratorioDTO laboratorio) {
		...
		return new WrapperResponse<>(true, "laboratorio actualizado de manera exitosa", laboratorioDto).createResponse(HttpStatus.OK);
	}
	...
	public ResponseEntity<WrapperResponse<LaboratorioDTO>> delete(@PathVariable("id") Long id) {
		...
		return new WrapperResponse<>(true, "laboratorio eliminado de manera exitosa", laboratorioDto).createResponse(HttpStatus.OK);
	}
